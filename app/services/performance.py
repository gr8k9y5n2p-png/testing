...
FUND_ALIASES: dict[str, str] = {
    ...
    "VYCAX": "VYCAX",
    "VOYA-CORPORATE-LEADERS-100": "VYCAX",
    "VOYA-CORPORATE-LEADERS-R-100-FUND": "VYCAX",
    "BRUSX": "BRUSX",
...
FUND_META: dict[str, dict[str, str]] = {
    ...
    "FCNTX": {"name": "Fidelity Contrafund", "asset_class": "equity"},
    ...
    "GGEZX": {"name": "GuideStone Growth Equity Investor", "asset_class": "equity"},
    "DHLAX": {"name": "Diamond Hill Large Cap Investor", "asset_class": "equity"},
    "BGAKX": {"name": "Baillie Gifford Global Alpha Equities K", "asset_class": "international"},
    ...
    "CPEAX": {"name": "Catalyst Dynamic Alpha Fund Class A", "asset_class": "equity"},
    "WHOSX": {"name": "Wasatch-Hoisington US Treasury", "asset_class": "fixed_income"},
    "WMCVX": {"name": "Wasatch Small Cap Value", "asset_class": "equity"},
    "GQETX": {"name": "GMO Quality III", "asset_class": "equity"},
    "VYCAX": {"name": "Voya Corporate Leaders 100 A", "asset_class": "equity"},
    "BRUSX": {"name": "Bridgeway Ultra-Small Company", "asset_class": "equity"},
    "ARGFX": {"name": "Ariel Fund Investor", "asset_class": "equity"},
    "POSKX": {"name": "PRIMECAP Odyssey Stock", "asset_class": "equity"},
    "ARAIX": {"name": "Ariel Fund Institutional", "asset_class": "equity"},
    "BMDIX": {"name": "Baird Mid Cap Growth Institutional", "asset_class": "equity"},
    "BMDSX": {"name": "Baird Mid Cap Growth Investor", "asset_class": "equity"},
    "BOSVX": {"name": "Bridgeway Omni Small-Cap Value N", "asset_class": "equity"},
    "CIPIX": {"name": "Champlain Mid Cap Institutional", "asset_class": "equity"},
    "CIPNX": {"name": "Champlain Small Company Institutional", "asset_class": "equity"},
    "DHIAX": {"name": "Diamond Hill International Inv", "asset_class": "international"},
    "DHMAX": {"name": "Diamond Hill Small-Mid Cap Inv", "asset_class": "equity"},
    "DHPAX": {"name": "Diamond Hill Mid Cap Inv", "asset_class": "equity"},
    "DHSCX": {"name": "Diamond Hill Small Cap Inv", "asset_class": "equity"},
    "DHTAX": {"name": "Diamond Hill Select Inv", "asset_class": "equity"},
    "DIAMX": {"name": "Diamond Hill Long-Short Inv", "asset_class": "equity"},
    "GMUEX": {"name": "GMO US Equity III", "asset_class": "equity"},
    "GTMIX": {"name": "GMO International Opportunistic Val III", "asset_class": "international"},
    "HWAIX": {"name": "Hotchkis & Wiley Opps Instl", "asset_class": "equity"},
    "HWLIX": {"name": "Hotchkis & Wiley Large Cap Fdml Value I", "asset_class": "equity"},
    "HWNIX": {"name": "Hotchkis & Wiley International Value I", "asset_class": "international"},
    "PAXDX": {"name": "Impax Global Sustainable Infrastructure Investor", "asset_class": "equity"},
    "PAXGX": {"name": "Impax Global Opportunities Investor", "asset_class": "equity"},
    "PAXIX": {"name": "Impax Sustainable Allocation Instl", "asset_class": "equity"},
    "PAXLX": {"name": "Impax Large Cap Fund Individual Investor", "asset_class": "equity"},
    "PAXWX": {"name": "Impax Sustainable Allocation Inv", "asset_class": "equity"},
    "PGINX": {"name": "Impax Global Environmental Markets Instl", "asset_class": "equity"},
    "PGRNX": {"name": "Impax Global Environmental Markets Inv", "asset_class": "equity"},
    "POAGX": {"name": "PRIMECAP Odyssey Aggressive Growth", "asset_class": "equity"},
    "POGRX": {"name": "PRIMECAP Odyssey Growth", "asset_class": "equity"},
    "PWGIX": {"name": "Impax US Sustainable Economy Instl", "asset_class": "equity"},
    "PXDIX": {"name": "Impax Global Sustainable Infrastructure Institutional", "asset_class": "equity"},
    "PXEAX": {"name": "Impax Global Environmental Markets A", "asset_class": "equity"},
    "PXGAX": {"name": "Impax US Sustainable Economy A", "asset_class": "equity"},
    "PXGOX": {"name": "Impax Global Opportunities Institutional", "asset_class": "equity"},
    "PXINX": {"name": "Impax International Sust Econ Inv", "asset_class": "international"},
    "PXLIX": {"name": "Impax Large Cap Fund Institutional", "asset_class": "equity"},
    "PXNIX": {"name": "Impax International Sust Econ Instl", "asset_class": "international"},
    "PXWEX": {"name": "Impax Global Women’s Leadership Investor", "asset_class": "equity"},
    "PXWGX": {"name": "Impax US Sustainable Economy Investor", "asset_class": "equity"},
    "PXWIX": {"name": "Impax Global Women’s Leadership Instl", "asset_class": "equity"},
}
