...
class DwsSource(HtmlTableSource):
    ...
    notes = (
        ...
        "re-emitted here. Alger leftovers "
        "stay reserved / disjoint. WAVE BG / BI / BK / BN leftover N-CSR "
        "paid history is fixture-only. Live most-recent retail PDF still "
        "omits 2021–2024; Wayback CDX offline. "
    ...
    live_limitations = (
        ...
        "(WAVE BG Dec 31, WAVE BI Oct 31, WAVE BK RREEF Dec 31, and WAVE BN "
        "Global Small Cap Oct 31) is fixture-only."
    )
