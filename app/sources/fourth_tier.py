...
class JohnHancockSource(HtmlTableSource):
    ...
    notes = (
        ...
        "Estimate press-release PDFs stay estimates. Does not redo WAVE "
        "CM JEEBX or WAVE CK TAGRX / JCCAX. Official 5y WAVE CN leftover "
        "(2026-09-17): John Hancock Investment Trust II FYE October 31 "
        "2025 N-CSR (accession 0001193125-25-327168) Financial Highlights "
        "unlock leftover Class A FIDAX / FRBAX 2021–2025 on the "
        "estimate-only in-book identities. Calendar-safe as_of 10/31. "
        "Class-level A — never sibling-copied onto FIDCX / JFIFX / "
        "JFDRX or FRBCX / JRBFX / JRGRX. Estimate press-release PDFs "
        "stay estimates. Does not redo WAVE CL SVBAX / JDIBX / JEMQX / "
        "JDJAX, WAVE CM JEEBX, or WAVE CK TAGRX / JCCAX. JVLAX "
        "Disciplined Value (Funds III FYE March 31) and JBGAX Blue Chip "
        "Growth (Funds II FYE August 31) stay unmatched — calendar-unsafe. "
        "Does not redo WAVE CJ Alger ALBAX / ALBCX / AGIZX, CI Federated "
        "SVALX, CH Harding HLEMX / HLGZX / HLIZX / HLFZX, CG RALIX / "
    ...
    def pages(self) -> list[PageSpec]:
        ...
        return [
            ...
            PageSpec(
                name="leftover_ncsr_fidax_frbax_2021_2025_wave_cn",
                url=(
