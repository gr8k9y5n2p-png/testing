...
class FidelitySource(HtmlTableSource):
    ...
    notes = (
        ...
        "re-probe; FIIS_SP10_DPL19 is 2025 Class K only, not a 2022–23 archive). "
        "No non-SPA HTML/PDF 2022–23 family book found — skip the DPL SPA wall. FCNTX 2022–2023 "
