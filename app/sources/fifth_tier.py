...
class NationwideSource(HtmlTableSource):
    ...
    notes = (
        ...
        "2024 stays unmatched (4y, not 5y). Official 5y parallel AC leftover "
        "(2026-09-16): Wayback 20250115 / 20250201 of the same unversioned "
        "MFN-0435AO are PDFs titled estimated year-end capital gains for 2024 "
        "(NWHOX / NWHJX / NTDAX still 4y). Live MFN-0435AO 403. Never store "
        "those 2024 estimate amounts as paid. Fund-profile API "
...
class VictorySource(HtmlTableSource):
    ...
    notes = (
        ...
        "USSPX ST $0.026267 / LT $2.615144; infer_stage treats title-only "
        "'Final Ordinary Income…' as final so 2025 counts). Pioneer / Victory Portfolios IV "
