...
class AmericanFundsSource(FundSource):
    ...
    notes = (
        ...
        "fixture mode still parses estimate + final snapshots for 2024 and 2025, but ingest "
        "scrubs a past prelim once a same-fund, same-year final/paid exists (has_estimate "
        "follows the future unpaid window only). Product-page paid history for AMCAP / "
