...
class AmundiSource(HtmlTableSource):
    ...
    notes = (
        ...
        "d578736dncsr.htm (0001193125-24-001420). Official 5y WAVE BU leftover "
        "(existing in-book only): Pioneer Mid Cap Value FYE October 31 N-CSR "
        "Financial Highlights unlock leftover 2021–2022 on the 2023–2025 paid "
        "Class A book (PCGRX). Calendar-safe as_of 10/31. Class-level — never "
        "sibling-copied (PCCGX / PYCGX / PMCKX). Income is ordinary "
        "income; net realized gain is unsplit total capital gains; 2021 CG dash "
    ...
    def pages(self) -> list[PageSpec]:
        return [
            ...
            PageSpec(
                name="leftover_ncsr_pcgrx_2021_2022_wave_bu",
                url=(
