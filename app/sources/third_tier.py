...
class AllspringSource(HtmlTableSource):
    ...
    notes = (
        ...
        "ST $0.97181 / LT $3.75956 (ex 2021-12-09). Wave 4 Institutional /i/ "
        "product pages: Special Large Cap Value EIVIX "
        "(2021 LT $2.51286 / 2025 LT $0.73096), Large Cap Core EGOIX "
...
class DodgeCoxSource(HtmlTableSource):
    ...
    notes = (
        ...
        "the May 2022 inception wall — never copy Class I 2021 onto DOXGX / "
        "DOXBX / DOXIX / DOXFX / DOXWX / DOXLX. "
        "Official 5y WAVE AO leftover re-probe (2026-09-17): Class X 2021 remains "
        "the May 2022 inception wall — never copy Class I 2021 onto DOXGX / "
        "DOXBX / DOXIX / DOXFX / DOXWX / DOXLX."
    )
...
class MfsSource(HtmlTableSource):
    ...
    notes = (
        ...
        "all-classes rows; MIGHX LT 8%–9%; published 0% stored). Tickers on "
        "official Class A product-page identifiers (MIGHX / MITTX / MFEGX / "
        "MGIAX / OTCAX / MFRFX / MTCAX) — the PDF has no ticker column. "
        "Paid YE / midyear from product pages plus official 10-year Excel "
        "(.../10YearsDistribution/download) for additional Class A pages "
        "(MEIAX / MFEGX / MFRFX / OTCAX / MVCAX / MSFRX / MGRAX / MGIAX / "
        "MNDAX / MTCAX / MMUFX plus Wave 4 Class A MRGAX / MDIDX / MWEFX / "
        "MWOFX / MIDAX / MAGWX / MAMAX / MRSAX / NDVAX / BRWAX). December YE "
        "2021–2025: MIGHX LT $3.35892 / $1.28192 / $1.38597 / $3.30240 / "
        "$4.20618; MEIAX LT $1.01429 / $2.67110 / $3.13988 / $3.57266 / "
        ...
        "Official 5y WAVE AO leftover re-probe (2026-09-17): official leftover "
        "shareCode Excel still has no 2023 row for BRSPX R1 / BRSHX C / BRSBX B / "
        "BRWRX R1 / MRSGX R1; MEMBX B still has no 2022 row; MNWTX R3 / MNWSX R2 / "
        "MCBCX C / MCBFX I / UIVIX I still have no 2021 row. Unpublished leftover "
        "years stay unmatched. MFEGX mid-year #186 not redone."
...
class LordAbbettSource(HtmlTableSource):
    ...
    notes = (
        ...
        "Official 5y WAVE AO leftover re-probe (2026-09-17): LAGWX 2022/2023 "
        "still unpublished on the product-page year dropdown; Developing Growth "
        "N-CSR FYE July 31 is not calendar-safe next to November/December "
        "product-page years. Daily AJAX year selector still 404."
    )
    live_limitations = (
