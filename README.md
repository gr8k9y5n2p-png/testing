...
**Official 5y parallel AB leftover (after `#182` / U tip digest 3556, in-book only):** Exclusive slice: Dodge & Cox share-class leftovers short of 5y, Artisan leftovers short of 5y, Oakmark / Harris leftovers short of 5y, Janus Henderson leftovers beyond already-merged income slices, and Lord Abbett leftovers short of 5y. Disjoint from mass X/Y/Z/AA, boutique A–W, parallel T `#181`, all-events `#188`, and parallel U `#182`. Adopts tip fills (T / all-events / U). Fixture digest on the `#182` tip was **3,556** (`funds_with_5y` 3,556 / MF 2,806 / ETF 750). After this slice **3,556 → 3,618** (`+62` five-year MF; ETF 5y unchanged at **750**). Live lock stays **`funds_total=10056`**. Calendar year stays **ex_date, else payable_date, else as_of**. Additive upserts only — existing identities, not new tickers.
