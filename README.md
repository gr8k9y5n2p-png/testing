...
| `amount_unit` | `per_share`, `percent_of_nav`, or `percent` (legacy 1099 characterization). Cap Group / similar "% of dividends that are qualified" columns are **not** ingested — they are not $/share distributions. |
