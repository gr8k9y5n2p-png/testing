...
**Wave 2 lookback (2021–2025 YE finals, $/share only):** American Funds public YE CG books now have tax-year as_of for 2021–2025 (Wayback id_ for 2021–2024; live 2025 table). Invesco ICI Primary broker XLSX is the 2023–2025 December book. BlackRock open-end 2021–2025 Investor A flatten unchanged (live 2025 h3 tables are not column-safe). JPMorgan 2021–2023 19a URLs still 404. Missing years stay unmatched / Undisclosed — never invented as $0 or ST/LT splits. Bare QDI % excluded from `lookback_5y`.
...
| American Funds | **2021–2025 full public YE CG books** (tax-year as_of) + AMCAP / GFA product-page history + 2024/2025 reprint + 2026 midyear | 2021–2024 individual YE URLs are 404; fixtures are Wayback id_ snapshots of the official tables with as_of = December ex-date (AMCAP 2021 LT $1.1710 / 2024 $2.5220 / 2025 $2.1509; no Dec 2022 AMCAP CG). 2025 tax-year book is the public YE table (January 2026 reprint as_of unchanged). Bare QDI % omitted. **CGHM** inception 6/25/24 — no 2021–2023 rows; official 2024/2025 YE em-dash ST/LT not stored as $0. |
