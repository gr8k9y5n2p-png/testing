...
**Official 5y WAVE BF leftover (rebased onto WAVE BD tip `539b0e68` digest 4180, in-book only):** Exclusive slice: leftover Baillie Gifford Class K / Institutional FYE December 31 2021–2024 issuer annual-statement / N-CSR Financial Highlights for classes already on the 2025 paid product-page Final book (BGAKX / BINSX / BGESX / BSGPX). BGCSX has no 2025 Final table. Preferred leftover families remasured as walls (William Blair leftover dashes; Allspring leftover FYE July 31; First Eagle GRA-Smid 2021 unpublished; Calamos CAISX 2021 inception; GuideStone index 2021; Beacon leftover all-dash years; Davis FYE July 31; Hodges FYE March 31; Boston Partners FYE Aug 31; Oberweis official 2023 dashes; RiverPark / Conestoga / Timothy FYE September 30; Buffalo FYE March 31; Jensen FYE May 31; leftover ETF wrappers FEGE / FEOE / CANQ / CCEF). Keeps sister BD LoCorr Dec 31 leftover rows (LFMIX / LCSIX / LOTIX / LEQIX stay 5y) and sister BB Boston Trust / BC Mairs &amp; Power + LKCM / BA Madison leftover rows. Does **not** redo BD LoCorr, BE Driehaus, BB Boston Trust, BC Mairs/LKCM, BA Madison, AZ Kinetics, AY Hennessy, AW Federated Kaufmann/SDG + Harding, AX FAM / Fenimore, AV Third Avenue, AU LSV, AT AMG Frontier / GW&amp;K, AQ Victory I/II, AS Virtus Asset Trust, AR Homestead, AO Fidelity Advisor Class I, AP Vanguard ICI Dec, or AN Hartford/Artisan. Fixture digest on the BD tip was **4,180** (`funds_with_5y` 4,180 / MF 3,422 / ETF 758). After this slice **4,180 → 4,184** (`+4` five-year MF; ETF 5y unchanged at **758**; book size unchanged — no new identities). Live lock stays **`funds_total=10056`**. Calendar year stays **ex_date, else payable_date, else as_of**. Additive upserts only. `SEED_FORCE_FULL` **off**. No schema / upsert-key / Manual Deploy.

| Family | 5y lift | Heroes | Walls |
|---|---|---|---|
| Baillie Gifford leftover Class K / Institutional Dec 31 2021–2024 annual statements / N-CSR | **+4 MF** | BGAKX 2021-12-31 OI **$0.33** / 2024-12-31 CG **$1.40**; BINSX 2024-12-31 OI **$0.08** / 2021-12-31 CG **$1.07**; BGESX 2022-12-31 CG **$0.05**; BSGPX 2022-12-31 CG **$0.11** / 2021-12-31 OI **$0.21** | BGCSX no 2025 Final table. Class K never sibling-copied onto Institutional BGASX / BGIKX / BGEKX / BGPKX. Issuer dashes omitted (BGAKX 2023 CG; BINSX 2023–2022 CG; BGESX 2022 OI; BSGPX 2024–2023 CG and 2022 OI) |
| William Blair leftovers | **+0** | none | LCGFX / LCGNX **2023** official dashes. WESNX / BESIX **2024** leftover dashes. WISNX **2022** unpublished. WBCIX **2021–2022** / ISMVX / WVMIX **2021** |
| Allspring leftovers | **+0** | none | FYE July 31 is not calendar-safe. WDSAX **2021** / EAAFX **2023** / ASPAX **2021** unpublished on product pages |
| First Eagle GRA-Smid leftovers | **+0** | none | FERAX / FESMX **2021** unpublished — issuer tables start 2022. Never invent 2021 |
| Calamos leftovers | **+0** | none | CAISX **2021** inception 03/31/22 |
...
| Oberweis leftovers | **+0** | none | OBMCX / OBEGX **2023** official CG dashes — year-depth only |
| Hodges leftovers | **+0** | none | FYE March 31 is not calendar-safe (HDPMX / HDPSX) |
| LoCorr leftover (sister BD `#227`) | **kept** | LFMIX / LCSIX / LOTIX / LEQIX stay 5y on tip | LHEIX 2021–2023 commencement wall. BF does not redo BD |
| Boston Trust leftover (sister BB `#225`) | **kept** | BTBFX / BTMFX / WSEFX stay 5y on tip | Out-of-book BTEFX / BOSOX omitted. BF does not redo BB |
...
| Driehaus leftover (sister BE `#228`) | **disjoint** | none claimed | DRESX / DSMDX / DIDEX stay walls. BF does not redo BE |

**Densified:** **Baillie Gifford** leftover Class K / Institutional FYE December 31 2021–2024 issuer annual-statement Financial Highlights (`baillie-gifford-funds-annual-financial-statements-2024`) verified against 2023 N-CSR `0001104659-24-030888` / `tm241460d1_ncsr.htm`. Class-level Class K BGAKX and Institutional BINSX / BGESX / BSGPX — never sibling-copied onto BGASX / BGIKX / BGEKX / BGPKX. Calendar-safe `as_of` 12/31. Income is ordinary income; net realized gain is unsplit total capital gains. Issuer dashes omitted, not $0. 2025 stays on the existing paid product-page Final book (BGAKX OI **$0.49581** / LT **$5.18723** is not overwritten by N-CSR 2-decimal highlights).

**Skipped (hard walls, not invented):** William Blair leftover dashes. Allspring July 31. First Eagle GRA-Smid 2021 unpublished. Calamos CAISX 2021 inception. GuideStone index 2021 unpublished. Davis / Hodges / Boston Partners / Grandeur Peak / RiverPark / Conestoga / Timothy / Buffalo / Jensen FYE not calendar-safe. Oberweis 2023 official dashes. American Beacon leftover all-dash years. Leftover ETF wrappers FEGE / FEOE / CANQ / CCEF 2025-only. BGCSX no Final table. Sister BD LoCorr leftover rows kept. BE Driehaus / BB Boston Trust / BC Mairs &amp; Power + LKCM / BA Madison / AZ Kinetics / AY Hennessy / AW Federated Kaufmann/SDG + Harding / AX FAM / AV Third Avenue / AU LSV / AT AMG / AQ Victory / AS Virtus / AR Homestead / AO Fidelity Class I / AP Vanguard ICI / AN Hartford/Artisan not redone. Missing years stay unmatched / Undisclosed. Smoke after seed: `GET /funds?q=BGAKX` / `BINSX` / `BGESX` / `BSGPX` / `LFMIX` / `BTBFX` / `MPGFX` / `LKEQX` / `LCGFX` / `FERAX` / `CAISX` / `DRESX`.
...
| 82 | `baillie_gifford` (aliases `baillie`, `bg`) | Baillie Gifford | implemented | PDF + N-CSR | 2025 estimate PDF; Institutional / Class K tickers BSGPX / BGCSX / BGAKX / BINSX / BGESX from official prospectus. WAVE BF leftover: Class K / Institutional FYE Dec 31 2021–2024 annual statements fill BGAKX 2021 OI $0.33 / 2024 CG $1.40; BINSX 2024 OI $0.08; BGESX 2022 CG $0.05; BSGPX 2022 CG $0.11. BGCSX no Final table. |
