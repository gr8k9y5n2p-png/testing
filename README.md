...
**Official 5y WAVE BD leftover (rebased onto WAVE BB tip `481e719` digest 4176, in-book only):** Exclusive slice: leftover LoCorr Class I FYE December 31 2021–2024 N-CSR Financial Highlights for classes already on the 2025 paid annual-distributions book (LFMIX / LCSIX / LOTIX / LEQIX). LHEIX 2024 is official year-depth only (commencement 7/10/2024). LSAIX commenced 1/8/2025. Preferred leftover families remasured as walls (William Blair leftover dashes; Allspring leftover FYE July 31; First Eagle GRA-Smid 2021 inception 11/30/21; Calamos CAISX 2021 inception; GuideStone index 2022 inception; Davis FYE July 31; American Beacon leftover all-dash years; Oberweis official 2023 dashes; Hodges FYE March 31; Grandeur Peak FYE April 30; RiverPark / Conestoga / Timothy FYE September 30; Buffalo FYE March 31; Jensen FYE May 31; leftover ETF wrappers FEGE / FEOE / CANQ / CCEF). Keeps sister BB Boston Trust Walden Dec 31 leftover rows (BTBFX / BTMFX / WSEFX stay 5y) and sister BC Mairs &amp; Power + LKCM / BA Madison leftover rows. Does **not** redo BB Boston Trust, BC Mairs/LKCM, BA Madison, AZ Kinetics, AY Hennessy, AW Federated Kaufmann/SDG + Harding, AX FAM / Fenimore, AV Third Avenue, AU LSV, AT AMG Frontier / GW&amp;K, AQ Victory I/II, AS Virtus Asset Trust, AR Homestead, AO Fidelity Advisor Class I, AP Vanguard ICI Dec, or AN Hartford/Artisan. Fixture digest on the BB tip was **4,176** (`funds_with_5y` 4,176 / MF 3,418 / ETF 758). After this slice **4,176 → 4,180** (`+4` five-year MF; ETF 5y unchanged at **758**; book size unchanged — no new identities). Live lock stays **`funds_total=10056`**. Calendar year stays **ex_date, else payable_date, else as_of**. Additive upserts only. `SEED_FORCE_FULL` **off**. No schema / upsert-key / Manual Deploy.

| Family | 5y lift | Heroes | Walls |
|---|---|---|---|
| LoCorr leftover Class I Dec 31 2021–2024 N-CSR | **+4 MF** | LFMIX 2021-12-31 OI **$0.41** / 2022-12-31 CG **$0.94** / 2024-12-31 ROC **$0.01**; LCSIX 2021-12-31 OI **$0.76**; LOTIX 2022-12-31 CG **$1.66**; LEQIX 2021-12-31 CG **$0.78** (2021–2022 OI dashes omitted) | LHEIX **2021–2023** commencement 7/10/2024 (2024 OI **$0.06** year-depth only). LSAIX commenced 1/8/2025. LSPIX not on the 2025 paid book. Class A / C never sibling-copied. LCSIX **2023** ROC less than $0.005 omitted |
| William Blair leftovers | **+0** | none | LCGFX / LCGNX **2023** official dashes. WESNX / BESIX **2024** leftover dashes. WISNX **2022** unpublished. WBCIX **2021–2022** / ISMVX / WVMIX **2021** |
| Allspring leftovers | **+0** | none | FYE July 31 is not calendar-safe. WDSAX **2021** / EAAFX **2023** / ASPAX **2021** unpublished on product pages |
| First Eagle GRA-Smid leftovers | **+0** | none | FERAX / FESMX **2021** unpublished — issuer tables start 2022. Never invent 2021 |
| Calamos leftovers | **+0** | none | CAISX **2021** inception 03/31/22 |
| GuideStone leftovers | **+0** | none | GEIZX / GVIZX / GIIZX **2021** unpublished / 2022 index inception |
| Davis leftovers | **+0** | none | FYE July 31 is not calendar-safe (NYVTX / RPEAX) |
| Oberweis leftovers | **+0** | none | OBMCX / OBEGX **2023** official CG dashes — year-depth only |
| Hodges leftovers | **+0** | none | FYE March 31 is not calendar-safe (HDPMX / HDPSX) |
| Boston Trust leftover (sister BB `#225`) | **kept** | BTBFX / BTMFX / WSEFX stay 5y on tip | Out-of-book BTEFX / BOSOX omitted. BD does not redo BB |
| Mairs &amp; Power + LKCM leftover (sister BC `#226`) | **kept** | MPGFX / LKEQX stay 5y on tip | MINN / LKSMX 2023–2024 dashes stay walls. BD does not redo BC |

**Densified:** **LoCorr** leftover Class I FYE December 31 2021–2024 N-CSR Financial Highlights (`0001133228-26-003096` / `lit-efp22581_ncsr.htm`) verified against 2024 issuer PDF `EFP-14022` and 2023 N-CSR `0001398344-24-005727`. Class-level Class I — never sibling-copied onto Class A / C. Calendar-safe `as_of` 12/31. Income is ordinary income; net realized gain is unsplit total capital gains; official printed ROC **$0.01** stored (LFMIX / LCSIX 2024). Issuer dashes and printed $0.00 less-than / rounded footnotes omitted, not $0. 2025 stays on the existing paid annual-distributions book (LFMIX OI **$0.2444** is not overwritten by N-CSR OI **$0.24**).

**Skipped (hard walls, not invented):** William Blair leftover dashes. Allspring July 31. First Eagle GRA-Smid 2021 unpublished. Calamos CAISX 2021 inception. GuideStone index 2021 unpublished. Davis / Hodges / Grandeur Peak / RiverPark / Conestoga / Buffalo / Jensen FYE not calendar-safe. Oberweis 2023 official dashes. American Beacon leftover all-dash years. Leftover ETF wrappers FEGE / FEOE / CANQ / CCEF 2025-only. Sister BB Boston Trust leftover rows kept. BC Mairs &amp; Power + LKCM / BA Madison / AZ Kinetics / AY Hennessy / AW Federated Kaufmann/SDG + Harding / AX FAM / AV Third Avenue / AU LSV / AT AMG / AQ Victory / AS Virtus / AR Homestead / AO Fidelity Class I / AP Vanguard ICI / AN Hartford/Artisan not redone. Missing years stay unmatched / Undisclosed. Smoke after seed: `GET /funds?q=LFMIX` / `LCSIX` / `LOTIX` / `LEQIX` / `LHEIX` / `BTBFX` / `MPGFX` / `LKEQX` / `MNVAX` / `WWWFX` / `HFCSX` / `LCGFX` / `FERAX` / `CAISX`.

**Official 5y WAVE BE leftover (rebased onto WAVE BD tip `539b0e6` digest 4180, in-book only):** Exclusive slice: leftover Driehaus Dec 31 2021–2024 N-CSR Financial Highlights for in-book identities already on the 2025 paid year-end PDF. Preferred leftover families remasured as walls (William Blair leftover beyond remasured walls; Allspring leftover FYE July 31; First Eagle GRA-Smid 2021 unpublished; Calamos CAISX 2021 inception; GuideStone index 2021 inception; Beacon leftover all-dash years; Davis FYE July 31; Boston Partners FYE Aug 31; Hodges FYE March 31). Keeps sister BD LoCorr Dec 31 leftover rows (LFMIX / LCSIX / LOTIX / LEQIX stay 5y), sister BB Boston Trust Walden Dec 31 leftover rows (BTBFX / BTMFX / WSEFX stay 5y), sister BC Mairs &amp; Power + LKCM Dec 31 leftover rows (MPGFX / LKEQX stay 5y), and sister BA Madison Oct 31 leftover rows (MNVAX / MAGSX stay 5y). Does **not** redo BD LoCorr, BB Boston Trust, BC Mairs/LKCM, BA Madison, AZ Kinetics, AY Hennessy, AW Federated Kaufmann/SDG + Harding, AX FAM / Fenimore, AV Third Avenue, AU LSV, AT AMG Frontier / GW&amp;K SMID, AQ Victory I/II, AS Virtus Asset Trust, AR Homestead, AO Fidelity Advisor Class I, AP Vanguard ICI Dec, or AN Hartford/Artisan. Fixture digest on the BD tip was **4,180** (`funds_with_5y` 4,180 / MF 3,422 / ETF 758). After this slice **4,180 → 4,188** (`+8` five-year MF; ETF 5y unchanged at **758**; book size unchanged — no new identities). Live lock stays **`funds_total=10056`**. Calendar year stays **ex_date, else payable_date, else as_of**. Additive upserts only. `SEED_FORCE_FULL` **off**. No schema / upsert-key / Manual Deploy.

| Family | 5y lift | Heroes | Walls |
|---|---|---|---|
| Driehaus leftover Dec 31 2021–2024 N-CSR | **+8 MF** | DMCRX 2024-12-31 OI **$0.30** / CG **$0.24**; DVSMX 2024-12-31 OI **$0.25**; DNSMX 2024-12-31 OI **$0.29** (class-level, not copied from DVSMX); DRIOX 2024-12-31 OI **$0.05**; DREGX 2024-12-31 OI **$0.33**; DIEMX 2024-12-31 OI **$0.42**; DEVDX 2024-12-31 OI **$0.17**; DMAGX 2024-12-31 OI **$0.09** / CG **$1.21** | DRESX **2022** official dash. DSMDX **2023** official dash. DIDEX **2021–2023** inception 04/30/24. Out-of-book DMCQX omitted (Eric freeze). 2025 N-CSR 2-decimal highlights not re-emitted |
| William Blair leftovers | **+0** | none | LCGFX **2023** official dash. WESNX **2024** official dash |
| Allspring leftovers | **+0** | none | FYE July 31 is not calendar-safe. WDSAX **2021** unpublished |
| First Eagle GRA-Smid leftovers | **+0** | none | FERAX **2021** unpublished — issuer tables start 2022. Never invent 2021 |
| Calamos leftovers | **+0** | none | CAISX **2021** inception 03/31/22 |
...
| American Beacon leftovers | **+0** | none | SFMIX **2023** / SSIJX **2024** / SPFYX **2025** official all-dash years |
| Davis leftovers | **+0** | none | FYE July 31 is not calendar-safe next to December product-page years |
| Hodges leftovers | **+0** | none | FYE March 31 is not calendar-safe |
| LoCorr leftover (sister BD `#227`) | **kept** | LFMIX / LCSIX / LOTIX / LEQIX stay 5y on tip | LHEIX 2024 year-depth only. LSAIX commenced 1/8/2025. BE does not redo BD |
| Boston Trust Walden leftover (sister BB `#225`) | **kept** | BTBFX / BTMFX / WSEFX stay 5y on tip | Out-of-book BTEFX / BOSOX omitted. BE does not redo BB |
| Mairs &amp; Power + LKCM leftover (sister BC `#226`) | **kept** | MPGFX / MAPOX / MSCFX / LKEQX / LKSCX / LKBAX stay 5y on tip | MINN / LKSMX 2023–2024 dashes stay walls. BE does not redo BC |
| Madison leftover (sister BA `#224`) | **kept** | MNVAX / MAGSX stay 5y on tip | ETF wrappers MAGG / MSTI stay 2025-only. BE does not redo BA |

**Densified:** **Driehaus** leftover Dec 31 2021–2024 Financial Highlights from the 2025 N-CSR (`0002066578-26-000860` / `8de7aed561cba19.htm`). Cross-checked against the 2024 N-CSR (`0001145549-25-016403` / `8dd5b73594a86ad.htm`) 2024 / 2023 / 2022 / 2021 columns. In-book only DMCRX / DVSMX / DNSMX / DRIOX / DREGX / DIEMX / DEVDX / DMAGX unlock 5y; official leftover years for DRESX / DSMDX / DIDEX stored where published. Income is ordinary income; net realized gain is unsplit total capital gains; tax return of capital is return of capital. 2025 stays on the existing paid PDF. Calendar-safe `as_of` 12/31. Class-level Investor / Institutional — never sibling-copied.

**Skipped (hard walls, not invented):** DRESX 2022 / DSMDX 2023 official dashes. DIDEX 2021–2023 inception. William Blair LCG 2023 / EM Small Cap 2024 dashes. Allspring July 31 / unpublished product-page years. First Eagle GRA-Smid 2021 unpublished. Calamos CAISX 2021 inception. GuideStone index 2021 inception. Beacon leftover all-dash years. Davis July 31. Hodges March 31. Boston Partners Aug 31. Out-of-book DMCQX omitted. Sister BD LoCorr / BB Boston Trust / BC Mairs/LKCM / BA Madison / AZ Kinetics / AY Hennessy / AW Federated+Harding / AX FAM / AV Third Avenue / AU LSV / AT AMG / AQ Victory / AS Virtus / AR Homestead not redone. Missing years stay unmatched / Undisclosed. Smoke after seed: `GET /funds?q=DMCRX` / `DVSMX` / `DNSMX` / `DRIOX` / `DREGX` / `DIEMX` / `DEVDX` / `DMAGX` / `LFMIX` / `LCSIX` / `LOTIX` / `LEQIX` / `BTBFX` / `MPGFX` / `LKEQX` / `MNVAX` / `WWWFX` / `HFCSX` / `KAUAX` / `FAMVX` / `TAVFX` / `LSVEX` / `YACKX` / `VETAX` / `STVTX` / `HOVLX` / `LCGFX` / `FERAX` / `CAISX`.

**Official 5y WAVE BF leftover (rebased onto WAVE BE tip `ec90eb6` digest 4188, in-book only):** Exclusive slice: leftover Baillie Gifford Funds Dec 31 2021–2024 N-CSR Financial Highlights for in-book Class K / Institutional identities already on the 2025 paid Final product-page book. Preferred leftover families remasured as walls (William Blair leftover beyond remasured walls; Allspring leftover FYE July 31; First Eagle GRA-Smid 2021 unpublished; Calamos CAISX 2021 inception; GuideStone index 2021 inception; Beacon leftover all-dash years; Davis FYE July 31; Oberweis official 2023 dashes; Hodges FYE March 31; Grandeur Peak FYE April 30; BGCSX no 2025 Final). Keeps sister BE Driehaus Dec 31 leftover rows (DMCRX / DVSMX / DNSMX stay 5y), sister BD LoCorr Dec 31 leftover rows (LFMIX / LCSIX / LOTIX / LEQIX stay 5y), sister BB Boston Trust Walden Dec 31 leftover rows (BTBFX / BTMFX / WSEFX stay 5y), and sister BC Mairs &amp; Power + LKCM Dec 31 leftover rows (MPGFX / LKEQX stay 5y). Does **not** redo BE Driehaus, BD LoCorr, BB Boston Trust, BC Mairs/LKCM, BA Madison, AZ Kinetics, AY Hennessy, AW Federated Kaufmann/SDG + Harding, AX FAM / Fenimore, AV Third Avenue, AU LSV, AT AMG Frontier / GW&amp;K SMID, AQ Victory I/II, AS Virtus Asset Trust, AR Homestead, AO Fidelity Advisor Class I, AP Vanguard ICI Dec, or AN Hartford/Artisan. Fixture digest on the BE tip was **4,188** (`funds_with_5y` 4,188 / MF 3,430 / ETF 758). After this slice **4,188 → 4,192** (`+4` five-year MF; ETF 5y unchanged at **758**; book size unchanged — no new identities). Live lock stays **`funds_total=10056`**. Calendar year stays **ex_date, else payable_date, else as_of**. Additive upserts only. `SEED_FORCE_FULL` **off**. No schema / upsert-key / Manual Deploy.

| Family | 5y lift | Heroes | Walls |
|---|---|---|---|
| Baillie Gifford leftover Dec 31 2021–2024 N-CSR | **+4 MF** | BGAKX Class K 2024-12-31 OI **$0.26** / CG **$1.40**; BINSX Institutional 2024-12-31 OI **$0.08** / CG **$0.45**; BGESX Institutional 2024-12-31 OI **$0.03** / CG **$0.89**; BSGPX Institutional 2024-12-31 OI **$0.33** | BGAKX **2023** CG dash. BINSX **2022–2023** CG dashes. BGESX **2022** OI dash. BSGPX **2024–2023** CG / **2022** OI dashes. Class-level — BGIKX / BGEKX / BGPKX / Global Alpha Institutional never sibling-copied. BGCSX has no 2025 Final. 2025 N-CSR 2-decimal highlights not re-emitted |
| William Blair leftovers | **+0** | none | LCGFX **2023** official dash. WESNX **2024** official dash |
| Allspring leftovers | **+0** | none | FYE July 31 is not calendar-safe. WDSAX **2021** unpublished |
| First Eagle GRA-Smid leftovers | **+0** | none | FERAX **2021** unpublished — issuer tables start 2022. Never invent 2021 |
| Calamos leftovers | **+0** | none | CAISX **2021** inception 03/31/22 |
| GuideStone leftovers | **+0** | none | GEIZX **2021** index inception |
| American Beacon leftovers | **+0** | none | SFMIX **2023** official all-dash year |
| Davis leftovers | **+0** | none | FYE July 31 is not calendar-safe next to December product-page years |
| Oberweis leftovers | **+0** | none | OBMCX **2023** official dash |
| Hodges leftovers | **+0** | none | FYE March 31 is not calendar-safe |
| Grandeur Peak leftovers | **+0** | none | FYE April 30 is not calendar-safe |
| Driehaus leftover (sister BE `#228`) | **kept** | DMCRX / DVSMX / DNSMX stay 5y on tip | DRESX 2022 / DSMDX 2023 dashes stay walls. BF does not redo BE |
| LoCorr leftover (sister BD `#227`) | **kept** | LFMIX / LCSIX / LOTIX / LEQIX stay 5y on tip | LHEIX 2024 year-depth only. BF does not redo BD |
| Boston Trust Walden leftover (sister BB `#225`) | **kept** | BTBFX / BTMFX / WSEFX stay 5y on tip | Out-of-book BTEFX / BOSOX omitted. BF does not redo BB |
| Mairs &amp; Power + LKCM leftover (sister BC `#226`) | **kept** | MPGFX / LKEQX stay 5y on tip | MINN / LKSMX 2023–2024 dashes stay walls. BF does not redo BC |

**Densified:** **Baillie Gifford** leftover Class K / Institutional FYE December 31 2021–2024 N-CSR Financial Highlights (`0001104659-25-020192` / `tm251686d1_ncsr.htm`) verified against 2023 N-CSR `0001104659-24-030888` (2023 / 2022 / 2021 columns match). Class-level Class K / Institutional — never sibling-copied. Calendar-safe `as_of` 12/31. Income is ordinary income; net realized gain is unsplit total capital gains. Issuer dashes omitted, not $0. 2025 stays on the existing paid Final product-page book (BGAKX LT **$5.18723** is not overwritten by N-CSR 2-decimal highlights).

**Skipped (hard walls, not invented):** William Blair leftover dashes. Allspring July 31. First Eagle GRA-Smid 2021 unpublished. Calamos CAISX 2021 inception. GuideStone index 2021 unpublished. Beacon leftover all-dash years. Davis / Hodges / Grandeur Peak FYE not calendar-safe. Oberweis 2023 official dashes. BGCSX no 2025 Final. Sister BE Driehaus leftover rows kept. BD LoCorr / BB Boston Trust / BC Mairs &amp; Power + LKCM / BA Madison / AZ Kinetics / AY Hennessy / AW Federated Kaufmann/SDG + Harding / AX FAM / AV Third Avenue / AU LSV / AT AMG / AQ Victory / AS Virtus / AR Homestead / AO Fidelity Class I / AP Vanguard ICI / AN Hartford/Artisan not redone. Missing years stay unmatched / Undisclosed. Smoke after seed: `GET /funds?q=BGAKX` / `BINSX` / `BGESX` / `BSGPX` / `DMCRX` / `LFMIX` / `BTBFX` / `MPGFX` / `LKEQX` / `MAGSX` / `WWWFX` / `HFCSX` / `LCGFX` / `FERAX` / `CAISX`.

**Official 5y WAVE BH leftover (rebased onto WAVE BF tip `09d3e96` digest 4192, in-book only):** Exclusive slice: leftover TCW Funds, Inc. Oct 31 2021–2024 N-CSR Financial Highlights for in-book Class I identities already on the 2025 paid Final PDF. Sister BG Alger Oct 31 leftover reserved / disjoint (higher-yield contested leftover). Preferred leftover families remasured as walls (William Blair leftover beyond remasured walls; Allspring leftover FYE July 31; First Eagle GRA-Smid 2021 unpublished; Calamos CAISX 2021 inception; GuideStone index 2021 inception; Beacon leftover all-dash years; Davis FYE July 31; Oberweis official 2023 dashes; Hodges FYE March 31; Grandeur Peak FYE April 30; AQR leftover FYE Sept 30; Meridian leftover FYE June 30; GQG leftover FYE March 31; Marsico leftover FYE Sept 30). Keeps sister BF Baillie Gifford Dec 31 leftover rows (BGAKX / BINSX / BGESX / BSGPX stay 5y), sister BE Driehaus Dec 31 leftover rows (DMCRX / DVSMX / DNSMX stay 5y), sister BD LoCorr Dec 31 leftover rows (LFMIX / LCSIX / LOTIX / LEQIX stay 5y), sister BB Boston Trust Walden Dec 31 leftover rows (BTBFX / BTMFX / WSEFX stay 5y), and sister BC Mairs &amp; Power + LKCM Dec 31 leftover rows (MPGFX / LKEQX stay 5y). Does **not** redo BF Baillie Gifford, BE Driehaus, BD LoCorr, BB Boston Trust, BC Mairs/LKCM, BA Madison, AZ Kinetics, AY Hennessy, AW Federated Kaufmann/SDG + Harding, AX FAM / Fenimore, AV Third Avenue, AU LSV, AT AMG Frontier / GW&amp;K SMID, AQ Victory I/II, AS Virtus Asset Trust, AR Homestead, AO Fidelity Advisor Class I, AP Vanguard ICI Dec, or AN Hartford/Artisan. Fixture digest on the BF tip was **4,192** (`funds_with_5y` 4,192 / MF 3,434 / ETF 758). After this slice **4,192 → 4,196** (`+4` five-year MF; ETF 5y unchanged at **758**; book size unchanged — no new identities). Live lock stays **`funds_total=10056`**. Calendar year stays **ex_date, else payable_date, else as_of**. Additive upserts only. `SEED_FORCE_FULL` **off**. No schema / upsert-key / Manual Deploy.

| Family | 5y lift | Heroes | Walls |
|---|---|---|---|
| TCW leftover Oct 31 2021–2024 N-CSR | **+4 MF** | TGDIX Class I 2024-10-31 OI **$0.20** / CG **$0.47**; TGVOX Class I 2024-10-31 OI **$0.21** / CG **$0.41**; TGCEX Class I 2024-10-31 CG **$3.28**; TGPCX Class I 2024-10-31 OI **$0.35** | TGPCX **2024** CG dash. TGVOX **2021** CG dash. TGCEX **2021–2024** net investment loss — no OI. Class-level — TGDVX / TGVNX / TGCNX / TGPNX never sibling-copied. Out-of-book Global Real Estate / EM Income / Core Fixed / Global Bond / High Yield / Securitized / Central Cash omitted. 2025 N-CSR 2-decimal highlights not re-emitted |
| Alger leftovers (sister BG reserved) | **+0** | none | CHUSX **2021 / 2023 / 2024** stay unmatched on this tip. BH does not take Alger |
| William Blair leftovers | **+0** | none | LCGFX **2023** official dash. WESNX **2024** official dash |
| Allspring leftovers | **+0** | none | FYE July 31 is not calendar-safe. WDSAX **2021** unpublished |
| First Eagle GRA-Smid leftovers | **+0** | none | FERAX **2021** unpublished — issuer tables start 2022. Never invent 2021 |
| Calamos leftovers | **+0** | none | CAISX **2021** inception 03/31/22 |
...
| Hodges leftovers | **+0** | none | FYE March 31 is not calendar-safe |
| Grandeur Peak leftovers | **+0** | none | FYE April 30 is not calendar-safe |
| AQR leftovers | **+0** | none | FYE September 30 is not calendar-safe next to December paid years |
| Baillie Gifford leftover (sister BF `#229`) | **kept** | BGAKX / BINSX / BGESX / BSGPX stay 5y on tip | BGCSX no 2025 Final. BH does not redo BF |
| Driehaus leftover (sister BE `#228`) | **kept** | DMCRX / DVSMX / DNSMX stay 5y on tip | DRESX 2022 / DSMDX 2023 dashes stay walls. BH does not redo BE |
| LoCorr leftover (sister BD `#227`) | **kept** | LFMIX / LCSIX / LOTIX / LEQIX stay 5y on tip | LHEIX 2024 year-depth only. BH does not redo BD |
| Boston Trust Walden leftover (sister BB `#225`) | **kept** | BTBFX / BTMFX / WSEFX stay 5y on tip | Out-of-book BTEFX / BOSOX omitted. BH does not redo BB |
| Mairs &amp; Power + LKCM leftover (sister BC `#226`) | **kept** | MPGFX / LKEQX stay 5y on tip | MINN / LKSMX 2023–2024 dashes stay walls. BH does not redo BC |

**Densified:** **TCW** leftover Class I FYE October 31 2021–2024 N-CSR Financial Highlights (`0001193125-25-000202` / `d911056dncsr.htm`) verified against 2023 N-CSR `0001193125-24-001879` (2023 / 2022 / 2021 columns match). Class-level Class I — never sibling-copied. Calendar-safe `as_of` 10/31. Income is ordinary income; net realized gain is unsplit total capital gains. Issuer dashes omitted, not $0. 2025 stays on the existing paid Final PDF (TGDIX LT **$3.4797** is not overwritten by N-CSR 2-decimal highlights). Dated 2021–2024 final PDFs and Incapsula-walled product pages stay unpublished.

**Skipped (hard walls, not invented):** Alger leftover reserved for sister BG. William Blair leftover dashes. Allspring July 31. First Eagle GRA-Smid 2021 unpublished. Calamos CAISX 2021 inception. GuideStone index 2021 unpublished. Beacon leftover all-dash years. Davis / Hodges / Grandeur Peak / AQR / Meridian / GQG / Marsico FYE not calendar-safe. Oberweis 2023 official dashes. Class N siblings never copied. Out-of-book TCW funds omitted. Sister BF Baillie leftover rows kept. BE Driehaus / BD LoCorr / BB Boston Trust / BC Mairs &amp; Power + LKCM / BA Madison / AZ Kinetics / AY Hennessy / AW Federated Kaufmann/SDG + Harding / AX FAM / AV Third Avenue / AU LSV / AT AMG / AQ Victory / AS Virtus / AR Homestead / AO Fidelity Class I / AP Vanguard ICI / AN Hartford/Artisan not redone. Missing years stay unmatched / Undisclosed. Smoke after seed: `GET /funds?q=TGDIX` / `TGVOX` / `TGCEX` / `TGPCX` / `BGAKX` / `DMCRX` / `LFMIX` / `BTBFX` / `MPGFX` / `LKEQX` / `MAGSX` / `WWWFX` / `HFCSX` / `CHUSX` / `LCGFX` / `FERAX` / `CAISX`.

**Official 5y WAVE BG leftover (rebased onto WAVE BH tip `d30e969` digest 4196, in-book only):** Exclusive slice: leftover DWS Equity 500 Index Class S / S&amp;P 500 Index Class A Dec 31 2021–2024 N-CSR Financial Highlights for in-book identities already on the 2025 paid retail capital-gains book. Preferred leftover families remasured as walls (William Blair leftover beyond remasured walls; Allspring leftover FYE July 31; First Eagle GRA-Smid 2021 unpublished; Calamos CAISX 2021 inception; GuideStone index 2021 inception; Beacon leftover all-dash years; Davis FYE July 31; Oberweis official 2023 dashes; Hodges FYE March 31; Grandeur Peak FYE April 30; KTCAX FYE Oct 31 not on this Dec 31 leftover page; SUWAX / SDGAX FYE Sep 30; DESAX ~Nov 30; Xtrackers 2021–2023 ICI 404). Keeps sister BH TCW Oct 31 leftover rows (TGDIX / TGVOX / TGCEX / TGPCX stay 5y), sister BF Baillie Gifford Dec 31 leftover rows (BGAKX / BINSX / BGESX / BSGPX stay 5y), sister BE Driehaus Dec 31 leftover rows (DMCRX / DVSMX / DNSMX stay 5y), sister BD LoCorr Dec 31 leftover rows (LFMIX / LCSIX / LOTIX / LEQIX stay 5y), sister BB Boston Trust Walden Dec 31 leftover rows (BTBFX / BTMFX / WSEFX stay 5y), and sister BC Mairs &amp; Power + LKCM Dec 31 leftover rows (MPGFX / LKEQX stay 5y). Does **not** redo BH TCW, BF Baillie Gifford, BE Driehaus, BD LoCorr, BB Boston Trust, BC Mairs/LKCM, BA Madison, AZ Kinetics, AY Hennessy, AW Federated Kaufmann/SDG + Harding, AX FAM / Fenimore, AV Third Avenue, AU LSV, AT AMG Frontier / GW&amp;K SMID, AQ Victory I/II, AS Virtus Asset Trust, AR Homestead, AO Fidelity Advisor Class I, AP Vanguard ICI Dec, or AN Hartford/Artisan. Fixture digest on the BH tip was **4,196** (`funds_with_5y` 4,196 / MF 3,438 / ETF 758). After this slice **4,196 → 4,198** (`+2` five-year MF; ETF 5y unchanged at **758**; book size unchanged — no new identities). Live lock stays **`funds_total=10056`**. Calendar year stays **ex_date, else payable_date, else as_of**. Additive upserts only. `SEED_FORCE_FULL` **off**. No schema / upsert-key / Manual Deploy.

| Family | 5y lift | Heroes | Walls |
|---|---|---|---|
| DWS leftover Dec 31 2021–2024 N-CSR | **+2 MF** | BTIEX Class S 2024-12-31 OI **$1.98** / CG **$29.51**; SXPAX Class A 2024-12-31 OI **$0.39** / CG **$2.20** | Class-level — BTIIX / BTIRX / SXPCX / SCPIX / SXPRX never sibling-copied. KTCAX FYE Oct 31 not on this Dec 31 leftover page. SUWAX / SDGAX FYE Sep 30 and DESAX ~Nov 30 not calendar-safe. Xtrackers 2021–2023 ICI 404. 2025 N-CSR 2-decimal highlights not re-emitted |
| William Blair leftovers | **+0** | none | LCGFX **2023** official dash. WESNX **2024** official dash |
| Allspring leftovers | **+0** | none | FYE July 31 is not calendar-safe. WDSAX **2021** unpublished |
| First Eagle GRA-Smid leftovers | **+0** | none | FERAX **2021** unpublished — issuer tables start 2022. Never invent 2021 |
| Calamos leftovers | **+0** | none | CAISX **2021** inception 03/31/22 |
...
| Hodges leftovers | **+0** | none | FYE March 31 is not calendar-safe |
| Grandeur Peak leftovers | **+0** | none | FYE April 30 is not calendar-safe |
| TCW leftover (sister BH `#231`) | **kept** | TGDIX / TGVOX / TGCEX / TGPCX stay 5y on tip | Class N siblings never copied. BG does not redo BH |
| Baillie Gifford leftover (sister BF `#229`) | **kept** | BGAKX / BINSX / BGESX / BSGPX stay 5y on tip | BGCSX no 2025 Final. BG does not redo BF |
| Driehaus leftover (sister BE `#228`) | **kept** | DMCRX / DVSMX / DNSMX stay 5y on tip | DRESX 2022 / DSMDX 2023 dashes stay walls. BG does not redo BE |
| LoCorr leftover (sister BD `#227`) | **kept** | LFMIX / LCSIX / LOTIX / LEQIX stay 5y on tip | LHEIX 2024 year-depth only. BG does not redo BD |
| Boston Trust Walden leftover (sister BB `#225`) | **kept** | BTBFX / BTMFX / WSEFX stay 5y on tip | Out-of-book BTEFX / BOSOX omitted. BG does not redo BB |
| Mairs &amp; Power + LKCM leftover (sister BC `#226`) | **kept** | MPGFX / LKEQX stay 5y on tip | MINN / LKSMX 2023–2024 dashes stay walls. BG does not redo BC |

**Densified:** **DWS** leftover Class S / Class A FYE December 31 2021–2024 N-CSR Financial Highlights (`0000088053-26-000209` / `ar123125e500.htm` Equity 500 Index; `0000088053-26-000213` / `ar123125spf500if.htm` S&amp;P 500 Index) verified against 2023 N-CSR `0000088053-24-000160` (2023 / 2022 / 2021 columns match). Class-level Class S / Class A — never sibling-copied. Calendar-safe `as_of` 12/31. Income is ordinary income; net realized gain is unsplit total capital gains. 2025 stays on the existing paid retail PDF (BTIEX LT **$16.0529** / SXPAX LT **$1.3491** are not overwritten by N-CSR 2-decimal highlights).

**Skipped (hard walls, not invented):** William Blair leftover dashes. Allspring July 31. First Eagle GRA-Smid 2021 unpublished. Calamos CAISX 2021 inception. GuideStone index 2021 unpublished. Beacon leftover all-dash years. Davis / Hodges / Grandeur Peak FYE not calendar-safe. Oberweis 2023 official dashes. KTCAX FYE Oct 31 not on this Dec 31 leftover page. SUWAX / SDGAX FYE Sep 30. DESAX ~Nov 30. Xtrackers 2021–2023 ICI 404. Sister BH TCW leftover rows kept. BF Baillie / BE Driehaus / BD LoCorr / BB Boston Trust / BC Mairs &amp; Power + LKCM / BA Madison / AZ Kinetics / AY Hennessy / AW Federated Kaufmann/SDG + Harding / AX FAM / AV Third Avenue / AU LSV / AT AMG / AQ Victory / AS Virtus / AR Homestead / AO Fidelity Class I / AP Vanguard ICI / AN Hartford/Artisan not redone. Missing years stay unmatched / Undisclosed. Smoke after seed: `GET /funds?q=BTIEX` / `SXPAX` / `TGDIX` / `BGAKX` / `DMCRX` / `LFMIX` / `BTBFX` / `MPGFX` / `LKEQX` / `MAGSX` / `WWWFX` / `HFCSX` / `LCGFX` / `FERAX` / `CAISX`.

**Official 5y WAVE BI leftover (rebased onto WAVE BJ tip `75efd49` digest 4200, in-book only):** Exclusive slice: leftover DWS Science and Technology Class A Oct 31 2021–2024 N-CSR Financial Highlights for the in-book identity already on the 2025 paid retail capital-gains book. Does **not** touch sister BJ RiverPark Dec YE leftovers (RWGIX / RWGFX stay 5y), sister BG Dec 31 leftovers (BTIEX / SXPAX stay 5y), sister BH TCW Oct 31 leftovers (TGDIX / TGVOX / TGCEX / TGPCX stay 5y), or prior BD–BF books (LoCorr LFMIX / LCSIX / LOTIX / LEQIX; Driehaus DMCRX / DVSMX / DNSMX; Baillie BGAKX / BINSX / BGESX / BSGPX). Alger leftovers reserved / disjoint. Preferred leftover families remasured as walls (Westwood WQAIX 2025 N-CSR FYE Oct 31 reprints already-booked December 2024 paid amounts and the 2025 AllCap final line is blank; WWMCX 2021 inception / 2022 official dash; William Blair leftover beyond remasured walls; Allspring leftover FYE July 31; First Eagle GRA-Smid 2021 unpublished; Calamos CAISX 2021 inception; GuideStone index 2021 inception; Beacon leftover all-dash years; Davis FYE July 31; Oberweis official 2023 dashes; Hodges FYE March 31; Grandeur Peak FYE April 30; Catalyst FYE June 30; SUWAX / SDGAX FYE Sep 30; DESAX ~Nov 30; Xtrackers 2021–2023 ICI 404). Does **not** redo BJ RiverPark, BG DWS Dec 31, BH TCW, BF Baillie Gifford, BE Driehaus, BD LoCorr, BB Boston Trust, BC Mairs/LKCM, BA Madison, AZ Kinetics, AY Hennessy, AW Federated Kaufmann/SDG + Harding, AX FAM / Fenimore, AV Third Avenue, AU LSV, AT AMG Frontier / GW&amp;K SMID, AQ Victory I/II, AS Virtus Asset Trust, AR Homestead, AO Fidelity Advisor Class I, AP Vanguard ICI Dec, or AN Hartford/Artisan. Fixture digest on the BJ tip was **4,200** (`funds_with_5y` 4,200 / MF 3,442 / ETF 758). After this slice **4,200 → 4,201** (`+1` five-year MF; ETF 5y unchanged at **758**; book size unchanged — no new identities). Live lock stays **`funds_total=10056`**. Calendar year stays **ex_date, else payable_date, else as_of**. Additive upserts only. `SEED_FORCE_FULL` **off**. No schema / upsert-key / Manual Deploy.

| Family | 5y lift | Heroes | Walls |
|---|---|---|---|
| DWS leftover Oct 31 2021–2024 N-CSR | **+1 MF** | KTCAX Class A 2024-10-31 CG **$3.60**; 2023-10-31 CG **$1.38**; 2022-10-31 CG **$3.99**; 2021-10-31 CG **$2.43** | KTCAX **2021–2024** net investment loss — no OI (never invent $0). Class-level — KTCCX / KTCIX / KTCSX never sibling-copied. 2025 N-CSR 2-decimal highlights not re-emitted. BTIEX / SXPAX not on this Oct 31 page |
| Westwood leftovers | **+0** | none | WQAIX **2025** N-CSR FYE Oct 31 reprints Dec 2024 paid OI **$0.16** / CG **$0.45**; 2025 AllCap final blank. WWMCX **2021–2022** inception / official dash. Ultra WQAUX never copied |
| William Blair leftovers | **+0** | none | LCGFX **2023** official dash. WESNX **2024** official dash |
| Allspring leftovers | **+0** | none | FYE July 31 is not calendar-safe. WDSAX **2021** unpublished |
| First Eagle GRA-Smid leftovers | **+0** | none | FERAX **2021** unpublished — issuer tables start 2022. Never invent 2021 |
| Calamos leftovers | **+0** | none | CAISX **2021** inception 03/31/22 |
...
| Hodges leftovers | **+0** | none | FYE March 31 is not calendar-safe |
| Grandeur Peak leftovers | **+0** | none | FYE April 30 is not calendar-safe |
| Catalyst leftovers | **+0** | none | FYE June 30 is not calendar-safe |
| RiverPark leftover (sister BJ `#233`) | **kept** | RWGIX / RWGFX stay 5y on tip | RPXIX / RPXFX 2023 dashes stay year-depth. BI does not redo BJ |
| DWS leftover (sister BG `#232`) | **kept** | BTIEX / SXPAX stay 5y on tip | Class siblings never copied. BI does not redo BG Dec 31 |
| TCW leftover (sister BH `#231`) | **kept** | TGDIX / TGVOX / TGCEX / TGPCX stay 5y on tip | Class N siblings never copied. BI does not redo BH |
| Baillie Gifford leftover (sister BF `#229`) | **kept** | BGAKX / BINSX / BGESX / BSGPX stay 5y on tip | BGCSX no 2025 Final. BI does not redo BF |
| Driehaus leftover (sister BE `#228`) | **kept** | DMCRX / DVSMX / DNSMX stay 5y on tip | DRESX 2022 / DSMDX 2023 dashes stay walls. BI does not redo BE |
| LoCorr leftover (sister BD `#227`) | **kept** | LFMIX / LCSIX / LOTIX / LEQIX stay 5y on tip | LHEIX 2024 year-depth only. BI does not redo BD |

**Densified:** **DWS** leftover Class A FYE October 31 2021–2024 N-CSR Financial Highlights (`0000088053-25-001134` / `ar103125dstf.htm`) verified against 2024 N-CSR `0000088053-25-000013` (2024 / 2023 / 2022 / 2021 columns match). Class-level Class A — never sibling-copied. Calendar-safe `as_of` 10/31. Net realized gain is unsplit total capital gains. Issuer net investment loss years omit ordinary income, not $0. 2025 stays on the existing paid retail PDF (KTCAX LT **$3.5700** is not overwritten by N-CSR 2-decimal highlights).

**Skipped (hard walls, not invented):** Westwood WQAIX 2025 N-CSR reprints Dec 2024 paid; 2025 AllCap final blank. WWMCX 2021–2022 inception / official dash. William Blair leftover dashes. Allspring July 31. First Eagle GRA-Smid 2021 unpublished. Calamos CAISX 2021 inception. GuideStone index 2021 unpublished. Beacon leftover all-dash years. Davis / Hodges / Grandeur Peak / Catalyst FYE not calendar-safe. Oberweis 2023 official dashes. SUWAX / SDGAX FYE Sep 30. DESAX ~Nov 30. Xtrackers 2021–2023 ICI 404. Class C / Institutional / Class S siblings never copied. Sister BJ RiverPark leftover rows kept. Sister BG DWS Dec 31 leftover rows kept. BH TCW / BF Baillie / BE Driehaus / BD LoCorr / BB Boston Trust / BC Mairs &amp; Power + LKCM / BA Madison / AZ Kinetics / AY Hennessy / AW Federated Kaufmann/SDG + Harding / AX FAM / AV Third Avenue / AU LSV / AT AMG / AQ Victory / AS Virtus / AR Homestead / AO Fidelity Class I / AP Vanguard ICI / AN Hartford/Artisan not redone. Alger leftover reserved. Missing years stay unmatched / Undisclosed. Smoke after seed: `GET /funds?q=KTCAX` / `RWGIX` / `RWGFX` / `BTIEX` / `SXPAX` / `TGDIX` / `BGAKX` / `DMCRX` / `LFMIX` / `WQAIX` / `CHUSX` / `LCGFX` / `FERAX` / `CAISX`.

**Official 5y WAVE BK leftover (rebased onto WAVE BI tip `71bb6b5` digest 4201, in-book only):** Exclusive slice: leftover DWS RREEF Global Infrastructure Class A Dec 31 2021–2024 N-CSR Financial Highlights for the in-book identity already on the 2025 paid retail capital-gains book. Does **not** touch sister BI DWS Oct 31 leftovers (KTCAX stays 5y), sister BJ RiverPark Dec YE leftovers (RWGIX / RWGFX stay 5y), sister BG Dec 31 leftovers (BTIEX / SXPAX stay 5y), sister BH TCW Oct 31 leftovers (TGDIX / TGVOX / TGCEX / TGPCX stay 5y), or prior BD–BF books (LoCorr LFMIX / LCSIX / LOTIX / LEQIX; Driehaus DMCRX / DVSMX / DNSMX; Baillie BGAKX / BINSX / BGESX / BSGPX). Alger leftovers reserved / disjoint. Preferred leftover families remasured as walls (Westwood WQAIX 2025 N-CSR FYE Oct 31 reprints already-booked December 2024 paid amounts and the 2025 AllCap final line is blank; WWMCX 2021 inception / 2022 official dash; William Blair leftover beyond remasured walls; Allspring leftover FYE July 31; First Eagle GRA-Smid 2021 unpublished; Calamos CAISX 2021 inception; GuideStone index 2021 inception; Beacon leftover all-dash years; Davis FYE July 31; Oberweis official 2023 dashes; Hodges FYE March 31; Grandeur Peak FYE April 30; Catalyst FYE June 30; SUWAX / SDGAX / SZCAX / DCUAX FYE Sep 30; DESAX / KDHAX ~Nov 30; SUHAX FYE May 31; KGDAX FYE Oct 31 not on this Dec 31 leftover page; Xtrackers 2021–2023 ICI 404). Does **not** redo BI DWS Oct 31, BJ RiverPark, BG DWS Dec 31, BH TCW, BF Baillie Gifford, BE Driehaus, BD LoCorr, BB Boston Trust, BC Mairs/LKCM, BA Madison, AZ Kinetics, AY Hennessy, AW Federated Kaufmann/SDG + Harding, AX FAM / Fenimore, AV Third Avenue, AU LSV, AT AMG Frontier / GW&amp;K SMID, AQ Victory I/II, AS Virtus Asset Trust, AR Homestead, AO Fidelity Advisor Class I, AP Vanguard ICI Dec, or AN Hartford/Artisan. Fixture digest on the BI tip was **4,201** (`funds_with_5y` 4,201 / MF 3,443 / ETF 758). After this slice **4,201 → 4,202** (`+1` five-year MF; ETF 5y unchanged at **758**; book size unchanged — no new identities). Live lock stays **`funds_total=10056`**. Calendar year stays **ex_date, else payable_date, else as_of**. Additive upserts only. `SEED_FORCE_FULL` **off**. No schema / upsert-key / Manual Deploy.

| Family | 5y lift | Heroes | Walls |
|---|---|---|---|
| DWS leftover RREEF Dec 31 2021–2024 N-CSR | **+1 MF** | TOLLX Class A 2024-12-31 OI **$0.39** / CG **$1.01**; 2023-12-31 OI **$0.30** / CG **$0.06**; 2022-12-31 OI **$0.21** / CG **$1.34**; 2021-12-31 OI **$0.18** / CG **$0.86** | Class-level — TOLCX / TOLSX / TOLIX / TOLZX never sibling-copied. 2025 N-CSR 2-decimal highlights not re-emitted. BTIEX / SXPAX / KTCAX not on this RREEF page |
| Westwood leftovers | **+0** | none | WQAIX **2025** N-CSR FYE Oct 31 reprints Dec 2024 paid OI **$0.16** / CG **$0.45**; 2025 AllCap final blank. WWMCX **2021–2022** inception / official dash. Ultra WQAUX never copied |
| William Blair leftovers | **+0** | none | LCGFX **2023** official dash. WESNX **2024** official dash |
| Allspring leftovers | **+0** | none | FYE July 31 is not calendar-safe. WDSAX **2021** unpublished |
| First Eagle GRA-Smid leftovers | **+0** | none | FERAX **2021** unpublished — issuer tables start 2022. Never invent 2021 |
...
| Grandeur Peak leftovers | **+0** | none | FYE April 30 is not calendar-safe |
| Catalyst leftovers | **+0** | none | FYE June 30 is not calendar-safe |
| DWS leftover (sister BI `#234`) | **kept** | KTCAX stays 5y on tip | Class siblings never copied. BK does not redo BI Oct 31 |
| RiverPark leftover (sister BJ `#233`) | **kept** | RWGIX / RWGFX stay 5y on tip | RPXIX / RPXFX 2023 dashes stay year-depth. BK does not redo BJ |
| DWS leftover (sister BG `#232`) | **kept** | BTIEX / SXPAX stay 5y on tip | Class siblings never copied. BK does not redo BG Dec 31 |
| TCW leftover (sister BH `#231`) | **kept** | TGDIX / TGVOX / TGCEX / TGPCX stay 5y on tip | Class N siblings never copied. BK does not redo BH |
| Baillie Gifford leftover (sister BF `#229`) | **kept** | BGAKX / BINSX / BGESX / BSGPX stay 5y on tip | BGCSX no 2025 Final. BK does not redo BF |
| Driehaus leftover (sister BE `#228`) | **kept** | DMCRX / DVSMX / DNSMX stay 5y on tip | DRESX 2022 / DSMDX 2023 dashes stay walls. BK does not redo BE |
| LoCorr leftover (sister BD `#227`) | **kept** | LFMIX / LCSIX / LOTIX / LEQIX stay 5y on tip | LHEIX 2024 year-depth only. BK does not redo BD |

**Densified:** **DWS** leftover Class A FYE December 31 2021–2024 N-CSR Financial Highlights (`0000088053-26-000211` / `ar123125drgif.htm`) verified against 2024 N-CSR `0000088053-25-000195` (2024 / 2023 / 2022 / 2021 leftover columns match the 2025 annual highlights and the June 30 2025 N-CSRS leftover columns). Class-level Class A — never sibling-copied. Calendar-safe `as_of` 12/31. Income is ordinary income; net realized gain is unsplit total capital gains. 2025 stays on the existing paid retail PDF (TOLLX LT **$1.1959** is not overwritten by N-CSR 2-decimal highlights).

**Skipped (hard walls, not invented):** Westwood WQAIX 2025 N-CSR reprints Dec 2024 paid; 2025 AllCap final blank. WWMCX 2021–2022 inception / official dash. William Blair leftover dashes. Allspring July 31. First Eagle GRA-Smid 2021 unpublished. Calamos CAISX 2021 inception. GuideStone index 2021 unpublished. Beacon leftover all-dash years. Davis / Hodges / Grandeur Peak / Catalyst FYE not calendar-safe. Oberweis 2023 official dashes. SUWAX / SDGAX / SZCAX / DCUAX FYE Sep 30. DESAX / KDHAX ~Nov 30. SUHAX FYE May 31. KGDAX FYE Oct 31 not on this Dec 31 leftover page. Xtrackers 2021–2023 ICI 404. Class C / Class S / Institutional / Class R6 siblings never copied. Sister BI DWS Oct 31 leftover rows kept. Sister BJ RiverPark leftover rows kept. Sister BG DWS Dec 31 leftover rows kept. BH TCW / BF Baillie / BE Driehaus / BD LoCorr / BB Boston Trust / BC Mairs &amp; Power + LKCM / BA Madison / AZ Kinetics / AY Hennessy / AW Federated Kaufmann/SDG + Harding / AX FAM / AV Third Avenue / AU LSV / AT AMG / AQ Victory / AS Virtus / AR Homestead / AO Fidelity Class I / AP Vanguard ICI / AN Hartford/Artisan not redone. Alger leftover reserved. Missing years stay unmatched / Undisclosed. Smoke after seed: `GET /funds?q=TOLLX` / `KTCAX` / `RWGIX` / `RWGFX` / `BTIEX` / `SXPAX` / `TGDIX` / `BGAKX` / `DMCRX` / `LFMIX` / `WQAIX` / `CHUSX` / `LCGFX` / `FERAX` / `CAISX`.

**Official 5y WAVE BN leftover (rebased onto WAVE BM tip `42cea68` digest 4212, in-book only):** Exclusive slice: leftover DWS Global Small Cap Class A Oct 31 2021–2024 N-CSR Financial Highlights for the in-book identity already on the 2025 paid retail capital-gains book. Does **not** touch sister BM Baird Chautauqua leftovers (CCGIX / CCGSX / CCWIX / CCWSX stay 5y), sister BL Thrivent leftovers (TMAIX / TMCVX / TSCSX / TCAIX / IBBFX / TWAIX stay 5y), sister BK DWS RREEF leftovers (TOLLX stays 5y), sister BI DWS Oct 31 leftovers (KTCAX stays 5y), sister BJ RiverPark Dec YE leftovers (RWGIX / RWGFX stay 5y), sister BG Dec 31 leftovers (BTIEX / SXPAX stay 5y), sister BH TCW Oct 31 leftovers (TGDIX / TGVOX / TGCEX / TGPCX stay 5y), or prior BD–BF books (LoCorr LFMIX / LCSIX / LOTIX / LEQIX; Driehaus DMCRX / DVSMX / DNSMX; Baillie BGAKX / BINSX / BGESX / BSGPX). Alger leftovers reserved / disjoint. Preferred leftover families remasured as walls (Westwood WQAIX 2025 N-CSR FYE Oct 31 reprints already-booked December 2024 paid amounts and the 2025 AllCap final line is blank; WWMCX 2021 inception / 2022 official dash; William Blair leftover beyond remasured walls; Allspring leftover FYE July 31; First Eagle GRA-Smid 2021 unpublished; Calamos CAISX 2021 inception; GuideStone index 2021 inception; Beacon leftover all-dash years; Davis FYE July 31; Oberweis official 2023 dashes; Hodges FYE March 31; Grandeur Peak FYE April 30; Catalyst FYE June 30; SUWAX / SDGAX / SZCAX / DCUAX FYE Sep 30; DESAX / KDHAX ~Nov 30; SUHAX FYE May 31; Xtrackers 2021–2023 ICI 404). Does **not** redo BM Baird Chautauqua, BL Thrivent, BK DWS RREEF, BI DWS Oct 31, BJ RiverPark, BG DWS Dec 31, BH TCW, BF Baillie Gifford, BE Driehaus, BD LoCorr, BB Boston Trust, BC Mairs/LKCM, BA Madison, AZ Kinetics, AY Hennessy, AW Federated Kaufmann/SDG + Harding, AX FAM / Fenimore, AV Third Avenue, AU LSV, AT AMG Frontier / GW&amp;K SMID, AQ Victory I/II, AS Virtus Asset Trust, AR Homestead, AO Fidelity Advisor Class I, AP Vanguard ICI Dec, or AN Hartford/Artisan. Fixture digest on the BM tip was **4,212** (`funds_with_5y` 4,212 / MF 3,454 / ETF 758). After this slice **4,212 → 4,213** (`+1` five-year MF; ETF 5y unchanged at **758**; book size unchanged — no new identities). Live lock stays **`funds_total=10056`**. Calendar year stays **ex_date, else payable_date, else as_of**. Additive upserts only. `SEED_FORCE_FULL` **off**. No schema / upsert-key / Manual Deploy.

| Family | 5y lift | Heroes | Walls |
|---|---|---|---|
| DWS leftover Global Small Cap Oct 31 2021–2024 N-CSR | **+1 MF** | KGDAX Class A 2024-10-31 OI **$0.20** / CG **$1.26**; 2023-10-31 CG **$1.32**; 2022-10-31 OI **$0.07** / CG **$5.84**; 2021-10-31 CG **$0.13** | Class-level — KGDCX / SGSCX / KGDIX / KGDZX never sibling-copied. 2021 OI issuer dash omitted. 2023 OI issuer printed $0.00* omitted (never invent $0). 2025 N-CSR 2-decimal highlights not re-emitted. TOLLX / KTCAX / BTIEX / SXPAX / CCGIX not on this Global Small Cap page |
| Baird leftover (sister BM `#237`) | **kept** | CCGIX / CCGSX / CCWIX / CCWSX stay 5y on tip | BSVIX / BSVSX 2023 official dash stay walls. BN does not redo BM |
| Thrivent leftover (sister BL `#236`) | **kept** | TMAIX / TMCVX / TSCSX / TCAIX / IBBFX / TWAIX stay 5y on tip | Class A siblings never copied. BN does not redo BL |
| DWS leftover (sister BK `#235`) | **kept** | TOLLX stays 5y on tip | Class siblings never copied. BN does not redo BK Dec 31 |
| DWS leftover (sister BI `#234`) | **kept** | KTCAX stays 5y on tip | Class siblings never copied. BN does not redo BI Oct 31 |
| RiverPark leftover (sister BJ `#233`) | **kept** | RWGIX / RWGFX stay 5y on tip | RPXIX / RPXFX 2023 dashes stay year-depth. BN does not redo BJ |
| DWS leftover (sister BG `#232`) | **kept** | BTIEX / SXPAX stay 5y on tip | Class siblings never copied. BN does not redo BG Dec 31 |
| TCW leftover (sister BH `#231`) | **kept** | TGDIX / TGVOX / TGCEX / TGPCX stay 5y on tip | Class N siblings never copied. BN does not redo BH |
| Baillie Gifford leftover (sister BF `#229`) | **kept** | BGAKX / BINSX / BGESX / BSGPX stay 5y on tip | BGCSX no 2025 Final. BN does not redo BF |
| Driehaus leftover (sister BE `#228`) | **kept** | DMCRX / DVSMX / DNSMX stay 5y on tip | DRESX 2022 / DSMDX 2023 dashes stay walls. BN does not redo BE |
| LoCorr leftover (sister BD `#227`) | **kept** | LFMIX / LCSIX / LOTIX / LEQIX stay 5y on tip | LHEIX 2024 year-depth only. BN does not redo BD |

**Densified:** **DWS** leftover Class A FYE October 31 2021–2024 N-CSR Financial Highlights (`0000088053-25-001132` / `ar103125dgsc.htm`) verified against 2024 N-CSR `0000088053-25-000010` and the April 30 2025 N-CSRS leftover columns (2024 / 2023 / 2022 / 2021 leftover columns match). Class-level Class A — never sibling-copied. Calendar-safe `as_of` 10/31. Income is ordinary income; net realized gain is unsplit total capital gains. Issuer dashes and printed $0.00* omitted — never invent $0. 2025 stays on the existing paid retail PDF (KGDAX ST **$0.5664** / LT **$2.5269** are not overwritten by N-CSR 2-decimal highlights).

**Skipped (hard walls, not invented):** Westwood WQAIX 2025 N-CSR reprints Dec 2024 paid; 2025 AllCap final blank. WWMCX 2021–2022 inception / official dash. William Blair leftover dashes. Allspring July 31. First Eagle GRA-Smid 2021 unpublished. Calamos CAISX 2021 inception. GuideStone index 2021 unpublished. Beacon leftover all-dash years. Davis / Hodges / Grandeur Peak / Catalyst FYE not calendar-safe. Oberweis 2023 official dashes. SUWAX / SDGAX / SZCAX / DCUAX FYE Sep 30. DESAX / KDHAX ~Nov 30. SUHAX FYE May 31. Xtrackers 2021–2023 ICI 404. Class C / Class S / Institutional / Class R6 siblings never copied. Sister BM Baird leftover rows kept. Sister BL Thrivent leftover rows kept. Sister BK DWS RREEF leftover rows kept. Sister BI DWS Oct 31 leftover rows kept. Sister BJ RiverPark leftover rows kept. Sister BG DWS Dec 31 leftover rows kept. BH TCW / BF Baillie / BE Driehaus / BD LoCorr / BB Boston Trust / BC Mairs &amp; Power + LKCM / BA Madison / AZ Kinetics / AY Hennessy / AW Federated Kaufmann/SDG + Harding / AX FAM / AV Third Avenue / AU LSV / AT AMG / AQ Victory / AS Virtus / AR Homestead / AO Fidelity Class I / AP Vanguard ICI / AN Hartford/Artisan not redone. Alger leftover reserved. Missing years stay unmatched / Undisclosed. Smoke after seed: `GET /funds?q=KGDAX` / `CCGIX` / `TMAIX` / `TOLLX` / `KTCAX` / `RWGIX` / `RWGFX` / `BTIEX` / `SXPAX` / `TGDIX` / `BGAKX` / `DMCRX` / `LFMIX` / `CHUSX` / `LCGFX` / `FERAX` / `CAISX`.

**Official 5y WAVE BO leftover (rebased onto WAVE BN tip `1952ce4` digest 4213, in-book only):** Exclusive slice: leftover DWS Global Income Builder Class A Oct 31 2021–2024 N-CSR Financial Highlights for the in-book identity already on the 2025 paid retail capital-gains book. Does **not** touch sister BN DWS Global Small Cap leftovers (KGDAX stays 5y), sister BM Baird Chautauqua leftovers (CCGIX / CCGSX / CCWIX / CCWSX stay 5y), sister BL Thrivent leftovers (TMAIX / TMCVX / TSCSX / TCAIX / IBBFX / TWAIX stay 5y), sister BK DWS RREEF leftovers (TOLLX stays 5y), sister BI DWS Oct 31 leftovers (KTCAX stays 5y), sister BJ RiverPark Dec YE leftovers (RWGIX / RWGFX stay 5y), sister BG Dec 31 leftovers (BTIEX / SXPAX stay 5y), sister BH TCW Oct 31 leftovers (TGDIX / TGVOX / TGCEX / TGPCX stay 5y), or prior BD–BF books (LoCorr LFMIX / LCSIX / LOTIX / LEQIX; Driehaus DMCRX / DVSMX / DNSMX; Baillie BGAKX / BINSX / BGESX / BSGPX). Alger leftovers reserved / disjoint. Preferred leftover families remasured as walls (Westwood WQAIX 2025 N-CSR FYE Oct 31 reprints already-booked December 2024 paid amounts and the 2025 AllCap final line is blank; WWMCX 2021 inception / 2022 official dash; William Blair leftover beyond remasured walls; Allspring leftover FYE July 31; First Eagle GRA-Smid 2021 unpublished; Calamos CAISX 2021 inception; GuideStone index 2021 inception; Beacon leftover all-dash years; Davis FYE July 31; Oberweis official 2023 dashes; Hodges FYE March 31; Grandeur Peak FYE April 30; Catalyst FYE June 30; SUWAX / SDGAX / SZCAX / DCUAX FYE Sep 30; DESAX / KDHAX ~Nov 30; SUHAX FYE May 31; Xtrackers 2021–2023 ICI 404). Does **not** redo BN DWS Global Small Cap, BM Baird Chautauqua, BL Thrivent, BK DWS RREEF, BI DWS Oct 31, BJ RiverPark, BG DWS Dec 31, BH TCW, BF Baillie Gifford, BE Driehaus, BD LoCorr, BB Boston Trust, BC Mairs/LKCM, BA Madison, AZ Kinetics, AY Hennessy, AW Federated Kaufmann/SDG + Harding, AX FAM / Fenimore, AV Third Avenue, AU LSV, AT AMG Frontier / GW&amp;K SMID, AQ Victory I/II, AS Virtus Asset Trust, AR Homestead, AO Fidelity Advisor Class I, AP Vanguard ICI Dec, or AN Hartford/Artisan. Fixture digest on the BN tip was **4,213** (`funds_with_5y` 4,213 / MF 3,455 / ETF 758). After this slice **4,213 → 4,214** (`+1` five-year MF; ETF 5y unchanged at **758**; book size unchanged — no new identities). Live lock stays **`funds_total=10056`**. Calendar year stays **ex_date, else payable_date, else as_of**. Additive upserts only. `SEED_FORCE_FULL` **off**. No schema / upsert-key / Manual Deploy.

| Family | 5y lift | Heroes | Walls |
|---|---|---|---|
| DWS leftover Global Income Builder Oct 31 2021–2024 N-CSR | **+1 MF** | KTRAX Class A 2024-10-31 OI **$0.34**; 2023-10-31 OI **$0.26**; 2022-10-31 OI **$0.23** / CG **$0.80**; 2021-10-31 OI **$0.22** | Class-level — KTRCX / KTRSX / KTRIX / KTRZX never sibling-copied. 2024 / 2023 / 2021 CG issuer dashes omitted (never invent $0). 2025 N-CSR 2-decimal highlights not re-emitted. KGDAX / TOLLX / KTCAX / BTIEX / SXPAX / CCGIX not on this Global Income Builder page |
| DWS leftover (sister BN `#238`) | **kept** | KGDAX stays 5y on tip | Class siblings never copied. BO does not redo BN Oct 31 |
| Baird leftover (sister BM `#237`) | **kept** | CCGIX / CCGSX / CCWIX / CCWSX stay 5y on tip | BSVIX / BSVSX 2023 official dash stay walls. BO does not redo BM |
| Thrivent leftover (sister BL `#236`) | **kept** | TMAIX / TMCVX / TSCSX / TCAIX / IBBFX / TWAIX stay 5y on tip | Class A siblings never copied. BO does not redo BL |
| DWS leftover (sister BK `#235`) | **kept** | TOLLX stays 5y on tip | Class siblings never copied. BO does not redo BK Dec 31 |
| DWS leftover (sister BI `#234`) | **kept** | KTCAX stays 5y on tip | Class siblings never copied. BO does not redo BI Oct 31 |
| RiverPark leftover (sister BJ `#233`) | **kept** | RWGIX / RWGFX stay 5y on tip | RPXIX / RPXFX 2023 dashes stay year-depth. BO does not redo BJ |
| DWS leftover (sister BG `#232`) | **kept** | BTIEX / SXPAX stay 5y on tip | Class siblings never copied. BO does not redo BG Dec 31 |
| TCW leftover (sister BH `#231`) | **kept** | TGDIX / TGVOX / TGCEX / TGPCX stay 5y on tip | Class N siblings never copied. BO does not redo BH |
| Baillie Gifford leftover (sister BF `#229`) | **kept** | BGAKX / BINSX / BGESX / BSGPX stay 5y on tip | BGCSX no 2025 Final. BO does not redo BF |
| Driehaus leftover (sister BE `#228`) | **kept** | DMCRX / DVSMX / DNSMX stay 5y on tip | DRESX 2022 / DSMDX 2023 dashes stay walls. BO does not redo BE |
| LoCorr leftover (sister BD `#227`) | **kept** | LFMIX / LCSIX / LOTIX / LEQIX stay 5y on tip | LHEIX 2024 year-depth only. BO does not redo BD |

**Densified:** **DWS** leftover Class A FYE October 31 2021–2024 N-CSR Financial Highlights (`0000088053-25-001130` / `ar103125dgib.htm`) verified against the issuer Oct 31 2025 Annual Financial Statements (DGIBF-NCSRA) and 2023 N-CSR `0000088053-23-000904` leftover columns (Class A 2023 OI **$0.26** matches). Class-level Class A — never sibling-copied. Calendar-safe `as_of` 10/31. Income is ordinary income; net realized gain is unsplit total capital gains. Issuer dashes omitted — never invent $0. 2025 stays on the existing paid retail PDF (KTRAX ST **$0.2807** / LT **$0.1744** are not overwritten by N-CSR 2-decimal highlights).

**Skipped (hard walls, not invented):** Westwood WQAIX 2025 N-CSR reprints Dec 2024 paid; 2025 AllCap final blank. WWMCX 2021–2022 inception / official dash. William Blair leftover dashes. Allspring July 31. First Eagle GRA-Smid 2021 unpublished. Calamos CAISX 2021 inception. GuideStone index 2021 unpublished. Beacon leftover all-dash years. Davis / Hodges / Grandeur Peak / Catalyst FYE not calendar-safe. Oberweis 2023 official dashes. SUWAX / SDGAX / SZCAX / DCUAX FYE Sep 30. DESAX / KDHAX ~Nov 30. SUHAX FYE May 31. Xtrackers 2021–2023 ICI 404. Class C / Class S / Institutional / Class R6 siblings never copied. Sister BN DWS Global Small Cap leftover rows kept. Sister BM Baird leftover rows kept. Sister BL Thrivent leftover rows kept. Sister BK DWS RREEF leftover rows kept. Sister BI DWS Oct 31 leftover rows kept. Sister BJ RiverPark leftover rows kept. Sister BG DWS Dec 31 leftover rows kept. BH TCW / BF Baillie / BE Driehaus / BD LoCorr / BB Boston Trust / BC Mairs &amp; Power + LKCM / BA Madison / AZ Kinetics / AY Hennessy / AW Federated Kaufmann/SDG + Harding / AX FAM / AV Third Avenue / AU LSV / AT AMG / AQ Victory / AS Virtus / AR Homestead / AO Fidelity Class I / AP Vanguard ICI / AN Hartford/Artisan not redone. Alger leftover reserved. Missing years stay unmatched / Undisclosed. Smoke after seed: `GET /funds?q=KTRAX` / `KGDAX` / `CCGIX` / `TMAIX` / `TOLLX` / `KTCAX` / `RWGIX` / `RWGFX` / `BTIEX` / `SXPAX` / `TGDIX` / `BGAKX` / `DMCRX` / `LFMIX` / `CHUSX` / `LCGFX` / `FERAX` / `CAISX`.
...
| 61 | `tcw` | TCW | implemented | PDF + N-CSR | 2025 paid Final PDF (TGDIX LT $3.4797). WAVE BH leftover: Oct 31 N-CSR Financial Highlights fill leftover TGDIX / TGVOX / TGCEX / TGPCX Class I 2021–2024. Class N siblings never copied. Dated 2021–2024 final PDFs unpublished. |
...
| 66 | `driehaus` | Driehaus | implemented | PDF + N-CSR | 2025 YE PDF (DMCRX ST $0.079978 / LT $2.073159). WAVE BE leftover: 2025 N-CSR Financial Highlights fill leftover DMCRX / DVSMX / DNSMX / DRIOX / DREGX / DIEMX / DEVDX / DMAGX 2021–2024. DRESX 2022 / DSMDX 2023 dashes and DIDEX 2021–2023 inception stay unmatched. |
...
| 82 | `baillie_gifford` (aliases `baillie`, `bg`) | Baillie Gifford | implemented | PDF + N-CSR | 2025 estimate PDF + paid Final; WAVE BF leftover: Dec 31 N-CSR Financial Highlights fill leftover BGAKX / BINSX / BGESX / BSGPX 2021–2024. BGCSX has no 2025 Final. |
...
| 107 | `locorr` | LoCorr | implemented | PDF + N-CSR | 2025 annual PDF (LEQIX ST $2.0297 / LFMIX OI $0.2444). WAVE BD leftover: Class I FYE Dec 31 2021–2024 N-CSR fills LFMIX 2021 OI $0.41 / 2022 CG $0.94; LCSIX 2021 OI $0.76; LOTIX 2022 CG $1.66; LEQIX 2021 CG $0.78. LHEIX 2024 year-depth only. LSAIX commenced 1/8/2025. |
