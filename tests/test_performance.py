...
def test_performance_new_top40_distribution_tickers(client: TestClient) -> None:
    for ticker, asset_class, bench in (
        ...
        ("BGFIX", "equity", "SPY"),
        ("AQGIX", "equity", "SPY"),
        ("CIVIX", "international", "VXUS"),
        ("CHUSX", "equity", "SPY"),
        ("HLMNX", "international", "VXUS"),
        ("MAPTX", "international", "VXUS"),
        ("TGDIX", "equity", "SPY"),
        ("BGLD", "equity", "SPY"),
        ("MWMIX", "equity", "SPY"),
        ("FEGE", "equity", "SPY"),
        ("INIVX", "equity", "SPY"),
        ("FEOE", "international", "VXUS"),
        ("XC", "international", "VXUS"),
        ("FVD", "equity", "SPY"),
        ("JENSX", "equity", "SPY"),
        ("HAVLX", "equity", "SPY"),
        ("VETAX", "equity", "SPY"),
        ...
        ("BOSVX", "equity", "SPY"),
        ("GMUEX", "equity", "SPY"),
        ("GTMIX", "international", "VXUS"),
        ("POGRX", "equity", "SPY"),
        ("POAGX", "equity", "SPY"),
        ("CIPIX", "equity", "SPY"),
        ("HWLIX", "equity", "SPY"),
        ("HWNIX", "international", "VXUS"),
        ("DHIAX", "international", "VXUS"),
        ("PAXLX", "equity", "SPY"),
        ("PXINX", "international", "VXUS"),
    ):
